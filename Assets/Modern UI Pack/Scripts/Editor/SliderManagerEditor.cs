            ...
            switch (currentTab)
            {
                case 0:
                    if (sliderTarget.mainSlider != null)
                    {
                        ...
                        EditorGUILayout.HelpBox("'Main Slider' is not assigned. Go to Resources tab and assign the correct variable.", (UnityEditor.MessageType)MessageType.Error);
                ...
                case 2:
                    ...
                    if (enableSaving.boolValue == true)
                    {
                        ...
                        GUILayout.Space(2);
                        EditorGUILayout.HelpBox("Each slider should has its own unique tag.", (UnityEditor.MessageType)MessageType.Info);
                    }
