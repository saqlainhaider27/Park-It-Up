                ...
                case 2:
                    ...
                    if (enableIndicators.boolValue == true)
                    {
                        if (hsTarget.indicatorObject == null)
                            EditorGUILayout.HelpBox("'Indicator Object' is not assigned. Go to Resources tab and assign the correct variable.", (UnityEditor.MessageType)MessageType.Error);

                        if (hsTarget.indicatorParent == null)
                            EditorGUILayout.HelpBox("'Indicator Parent' is not assigned. Go to Resources tab and assign the correct variable.", (UnityEditor.MessageType)MessageType.Error);
                    ...
                    if (saveValue.boolValue == true)
                    {
                        ...
                        GUILayout.EndHorizontal();
                        EditorGUILayout.HelpBox("Each selector should has its own unique tag.", (UnityEditor.MessageType)MessageType.Info);
                    }
