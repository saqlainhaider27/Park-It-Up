            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    else
                    {
                        ...
                        {
                            GUILayout.BeginHorizontal();
                            EditorGUILayout.HelpBox("'Icon Object' is not assigned. Go to Resources tab and assign the correct variable.", (UnityEditor.MessageType)MessageType.Error);
                            GUILayout.EndHorizontal();
                        }
                    }
                    ...
                    else
                    {
                        ...
                        {
                            GUILayout.BeginHorizontal();
                            EditorGUILayout.HelpBox("'Title Object' is not assigned. Go to Resources tab and assign the correct variable.", (UnityEditor.MessageType)MessageType.Error);
                            GUILayout.EndHorizontal();
                        }
                    }
                    ...
                    else
                    {
                        ...
                        {
                            GUILayout.BeginHorizontal();
                            EditorGUILayout.HelpBox("'Description Object' is not assigned. Go to Resources tab and assign the correct variable.", (UnityEditor.MessageType)MessageType.Error);
                            GUILayout.EndHorizontal();
                        }
                    }
