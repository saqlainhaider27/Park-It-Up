    ...
    public class UIManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (showContext)
            {
                ...
                GUILayout.EndHorizontal();
                EditorGUILayout.HelpBox("Context Menu is currently in beta, expect major changes in future releases.", (UnityEditor.MessageType)MessageType.Info);
            }
            ...
            if (showDropdown && dropdownTheme.enumValueIndex == 0)
            {
                ...
                GUILayout.EndHorizontal();
                EditorGUILayout.HelpBox("Item values will be applied at start.", (UnityEditor.MessageType)MessageType.Info);
            }
            ...
            if (showModalWindow)
            {
                ...
                GUILayout.EndHorizontal();
                EditorGUILayout.HelpBox("These values will only affect 'Style 1 - Standard' window.", (UnityEditor.MessageType)MessageType.Info);
            }
            ...
            {
                EditorGUILayout.HelpBox("These values are universal and will affect any object that contains 'UI Manager' component.", (UnityEditor.MessageType)MessageType.Info);
                EditorGUILayout.HelpBox("Remove 'UI Manager' component from the object if want to assign unique values.", (UnityEditor.MessageType)MessageType.Info);
				EditorGUILayout.HelpBox("You can press 'CTRL + SHIFT + M' to open UI Manager quickly.", (UnityEditor.MessageType)MessageType.Info);
            }
            ...
            if (changeRootFolder.boolValue == true)
            {
                ...
                EditorGUILayout.HelpBox("Use this option only if you're moving Modern UI Pack folder. " +
                    ...
                    "Example: Parent Folders/Modern UI Pack/Prefabs.", (UnityEditor.MessageType)MessageType.Warning);
            }
