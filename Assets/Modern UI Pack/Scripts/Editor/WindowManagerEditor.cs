            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    if (wmTarget.windows.Count != 0)
                    {
                        ...
                        {
                            EditorGUILayout.HelpBox("While Edit Mode is enabled, you can change the visibility of window objects by changing the slider value.", (UnityEditor.MessageType)MessageType.Info);
                        ...
                        EditorGUILayout.HelpBox("Window List is empty. Create a new item to see more options.", (UnityEditor.MessageType)MessageType.Info);
