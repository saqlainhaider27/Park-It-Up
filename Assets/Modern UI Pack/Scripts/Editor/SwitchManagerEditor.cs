            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    if (saveValue.boolValue == true)
                        EditorGUILayout.HelpBox("Save Value is enabled. This option won't be used if there's a stored value.", (UnityEditor.MessageType)MessageType.Info);
                    ...
                    if (saveValue.boolValue == true)
                    {
                        ...
                        GUILayout.Space(2);
                        EditorGUILayout.HelpBox("Each switch should has its own unique tag.", (UnityEditor.MessageType)MessageType.Info);
                    }
