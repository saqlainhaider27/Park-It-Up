            ...
            switch (currentTab)
            {
                ...
                case 2:
                    ...
                    else
                    {
                        ...
                        {
                            GUILayout.BeginHorizontal();
                            EditorGUILayout.HelpBox("'Selected Image' is not assigned. Go to Resources tab and assign the correct variable.", (UnityEditor.MessageType)MessageType.Error);
                            GUILayout.EndHorizontal();
                        }                       
                    }
                    ...
                    {
                        GUILayout.BeginHorizontal();
                        EditorGUILayout.HelpBox("'Trigger Object' is not assigned. Go to Resources tab and assign the correct variable.", (UnityEditor.MessageType)MessageType.Error);
                        GUILayout.EndHorizontal();
                    }
                    ...
                    else
                    {
                        ...
                        {
                            GUILayout.BeginHorizontal();
                            EditorGUILayout.HelpBox("'Scrollbar' is not assigned. Go to Resources tab and assign the correct variable.", (UnityEditor.MessageType)MessageType.Error);
                            GUILayout.EndHorizontal();
                        }                     
                    }
                    ...
                    {
                        GUILayout.BeginHorizontal();
                        EditorGUILayout.HelpBox("'List Parent' is not assigned. Go to Resources tab and assign the correct variable.", (UnityEditor.MessageType)MessageType.Error);
                        GUILayout.EndHorizontal();
                    }
                    ...
                    if (enableDropdownSounds.boolValue == true)
                    {
                        ...
                        {
                            EditorGUILayout.HelpBox("'Sound Source' is not assigned. Go to Resources tab or click the button to create a new audio source.", (UnityEditor.MessageType)MessageType.Info);
                    ...
                    if (saveSelected.boolValue == true)
                    {
                        ...
                        GUILayout.EndHorizontal();
                        EditorGUILayout.HelpBox("Each dropdown should has its own unique tag.", (UnityEditor.MessageType)MessageType.Info);
                    }
                    ...
                    if (dTarget.dropdownItems.Count != 0)
                    {
                        ...
                        if (saveSelected.boolValue == true)
                            EditorGUILayout.HelpBox("Save Selection is enabled. This option won't be used if there's a stored value.", (UnityEditor.MessageType)MessageType.Info);
                    }

                    else
                        EditorGUILayout.HelpBox("There is no item in the list.", (UnityEditor.MessageType)MessageType.Warning);
